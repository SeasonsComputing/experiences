...
import { Checklist, Activity, ActivityStatus } from '../hotel.domain';
import { HotelService } from '../hotel.service';

import ActivityCompleted from '../assets/activity-completed.svg';
import ActivityDenied from '../assets/activity-denied.svg';
import ActivityUserEmpty from '../assets/activity-user-empty.svg';
import '../app.css';
...
export class ActivityView extends Component<ActivityProps, ActivityState> {
  ...
  async componentDidMount() {
    try {
      ...
      const list: Checklist = await HotelService.getChecklist(this.props.listId);
      const history: Activity[] = await HotelService.getHistory({
