...
import { Facility, Space, Activity } from './facility.domain';
...
import { GuestServicesView } from './guestservices.component';
import { ActivityView } from './activity.component';

import TapwowWelcome from './tapwow-welcome-ill.svg';
import TapwowDoNotDisturb from './tapwow-dnd-ill.svg';
import './app.css';
...
class App extends Component<{}, AppState> {
  ...
  async toggleDoNotDisturb() {
    ...
    space.dnd = !space.dnd;
    await FacilityApi.setDoNotDisturb(space.id, space.dnd);
    this.setState({ space });
  }

  async recordActivity(a: Activity) {
    await FacilityApi.putActivity(a);
